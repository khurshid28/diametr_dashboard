...
import { Service } from "../../../pages/diametr/Services";
...
export default function ServicesTable({
  ...
  let currentItems: ServiceItemProps[] = tableData.slice(startIndex, endIndex);
                  ...
                  <div className="flex items-center gap-3">
                    <div className=" overflow-hidden rounded-sm ">
                      {order.image ? (
                        ...
                        <ServiceIcon className="w-10 h-10 text-gray-500  text-theme-sm dark:text-gray-400" />
                      )}
                    </div>
                    <div>
