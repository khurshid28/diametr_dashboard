...
export default function ServicesPage() {
  ...
  let [Service, setService] = useState<Service>(emptyService);
  ...
  //     return axiosClient.get("/Service/all").then((res) => res.data);
  //   }, []);
  ...
  return (
    <>
      <PageMeta
        title="Services | Diametr Dashboard"
        ...
        <div className="relative w-full p-4 overflow-y-auto bg-white no-scrollbar rounded-3xl dark:bg-gray-900 lg:p-11">
          <div className="px-2 pr-14">
            ...
            <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              Create new Service with full details.
            </p>
          </div>
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                <div>
                  ...
                  <Input
                    type="text"
                    value={Service.name}
                    onChange={(e) => setService(emptyService)}
                  />
                </div>
                <div>
                  <Label>Image</Label>
